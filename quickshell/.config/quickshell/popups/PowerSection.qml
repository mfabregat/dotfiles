// popups/PowerSection.qml — lock / logout / suspend / reboot / shutdown
// block, shared by the power menu popup and the control center.
...
Column {
    ...
    /// Emitted when any action fires (embedders close themselves).
